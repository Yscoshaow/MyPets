...
abstract class ID(pack: QuestPackage?, val identifier: String) {
    ...
    init {
        if(identifier.contains(".")) {
            ...
            if(pack != null && packName.startsWith("$UP_STR-")) {
                ...
                val potentialPack = MainActivity.INSTANCE.questManager.getQuestPackage(packName)
            ...
            this.pack = MainActivity.INSTANCE.questManager.getQuestPackage(packName)!!
        } else {
            if(pack != null) {
                this.pack = pack
            } else {
    ...
    private  fun resolveRelativePathUp(
        ...
        this.pack = MainActivity.INSTANCE.questManager.getQuestPackage(absolute)!!
    }
    ...
    private fun resolveRelativePathDown(
        ...
        this.pack = MainActivity.INSTANCE.questManager.getQuestPackage(fullPath)!!
    }
